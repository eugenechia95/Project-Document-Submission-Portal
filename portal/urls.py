...
urlpatterns += [ 
    ...
    path('project/<uuid:pk>/mod/mne/', views.documents, name='mdmne'),
    ...
    path('project/<uuid:pk>/mod/mne/create/', views.documentscreate, name='modmnecreate'),
    ...
    path('project/<uuid:pk>/mod/mne/addtemplate/', views.addtemplate, name='modmneaddtemplate'),
...
urlpatterns += [ 
    ...
    path('project/<uuid:pk>/mod/idd/', views.documents, name='mdid'),
    ...
    path('project/<uuid:pk>/mod/idd/create/', views.documentscreate, name='modidcreate'),
    ...
    path('project/<uuid:pk>/mod/idd/addtemplate/', views.addtemplate, name='modiddaddtemplate'),
...
urlpatterns += [ 
    ...
    path('project/<uuid:pk>/mod/arc/', views.documents, name='mdarc'),
    ...
    path('project/<uuid:pk>/mod/arc/create/', views.documentscreate, name='modarccreate'),
    ...
    path('project/<uuid:pk>/mod/arc/addtemplate/', views.addtemplate, name='modarcaddtemplate'),
